 ...
 * 
 * test the cartesianspace controller by adding it to the robot arm control manager
 * 
 * @param argc 
 * @param argv 
 * @return int 
...
int main(int argc, char **argv)
{
    ...
    tum_ics_ur_robot_lli::RobotControllers::CartesianSpaceController controller(1.0, "cartesianspace_controller");
